...
LABEL org.opencontainers.image.source="https://github.com/Humans-Not-Required/app-directory"
LABEL org.opencontainers.image.description="App directory and discovery service for AI agents"
